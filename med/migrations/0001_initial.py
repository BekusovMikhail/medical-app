# Generated by Django 4.0.3 on 2022-05-10 15:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Clinic',
            fields=[
                ('ava', models.ImageField(blank=True, null=True, upload_to='uploads')),
                ('description', models.TextField(blank=True)),
                ('specialization', models.CharField(default='', max_length=200)),
                ('address', models.CharField(default='', max_length=75)),
                ('extra', models.CharField(default='Нет дополнительной информации', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ava', models.ImageField(blank=True, null=True, upload_to='uploads')),
                ('specialization', models.CharField(default='Пациент', max_length=200)),
                ('extra', models.CharField(default='', max_length=1000)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
